...
function Pedidos() {
    ...
    // Renderiza la tabla de pedidos programados
    const renderPedidosProgramados = () => {
        return (
    ...
    const renderContent = () => {
        switch(activeTab) {
            case "programados":
                return renderPedidosProgramados();
            case "activos":
                return <PedidosActivos />;
            case "finalizados":
                return <div className="empty-state">No hay pedidos finalizados</div>;
            default:
                return renderPedidosProgramados();
        }
    };
...
function options(setIdOptions, setShowCancel){
    return(
        <div className="optionsQuery">
            <div className="delete-query" onClick={() => handleCancel()}>
